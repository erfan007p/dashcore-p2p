...
function builder(options) {
  ...
  if (!options.network) {
    options.network = gobytecore.Networks.defaultNetwork;
  }

  options.Block = options.Block || gobytecore.Block;
  options.BlockHeader = options.BlockHeader || gobytecore.BlockHeader;
  options.Transaction = options.Transaction || gobytecore.Transaction;
  options.MerkleBlock = options.MerkleBlock || gobytecore.MerkleBlock;
  options.MnListDiff = options.MnListDiff || gobytecore.MnListDiff;
  options.protocolVersion = options.protocolVersion || 70209;
