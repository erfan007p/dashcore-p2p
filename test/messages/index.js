...
describe('Messages', function() {
  ...
  describe('@constructor', function() {
    it('sets properties correctly', function() {
      var network = gobytecore.Networks.defaultNetwork;
      var messages = new Messages({
        network: network,
      ...
      messages.builder.constructors.Block.should.equal(gobytecore.Block);
      messages.builder.constructors.Transaction.should.equal(gobytecore.Transaction);
    ...
    it('network should be unique for each set of messages', function() {
      ...
      messages.network.should.deep.equal(gobytecore.Networks.livenet);
      messages2.network.should.deep.equal(gobytecore.Networks.testnet);
      var message1 = messages.Version();
      message1.network.should.deep.equal(gobytecore.Networks.livenet);
      var message2 = messages2.Version();
      message2.network.should.deep.equal(gobytecore.Networks.testnet);
    });
  });
  ...
  describe('Default Network', function() {
    ...
    Object.keys(messages.builder.commandsMap).forEach(function(command) {
      ...
      it(name, function() {
        var message = messages[name]();
        message.network.should.deep.equal(gobytecore.Networks.defaultNetwork);
      });
    });
  ...
  describe('#parseBuffer', function() {
    it('fails with invalid command', function() {
      var invalidCommand = '1ab2c3d46d616c6963696f757300000025000000bd5e830c' +
    ...
    it('ignores malformed messages', function() {
      ...
      var malformed2 = '1ab2c3d467657464617461000000000089000000d88134740102' +
        '0000006308e4a380c949dbad182747b0f7b6a89e874328ca41f37287f74a81b8f84' +
        '86d';
      var malformed3 = '1ab2c3d467657464617461000000000025000000616263640102' +
